...
<body onload="init();">
    <div class="box-login nyro-content">
        <form role="form" class="form-horizontal" method="post" action="<?php echo site_url('persuratan/surat_masuk/edit_proccess/'.$surat['id_surat']); ?>" enctype="multipart/form-data">
            <div id="tabs">
                ...
                <div id="tabs-1" class="tabs-content fade in active"> 
                    ...
                    <fieldset>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <input  type="text" placeholder="Dari" name="dari" value="<?php echo $surat['dari'] ?>" class="form-control">
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="col-sm-2 control-label">
