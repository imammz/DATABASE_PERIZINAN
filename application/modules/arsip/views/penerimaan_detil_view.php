                        ...
                        <div class="tab-content">
                                                        ...
                                                        <tr>
                                                            <td valign="top">
                                                                <div class="form-group">
                                                                    ...
                                                                    <div class="col-sm-9">
                                                                        <select disabled id="kode_klasifikasi" name="kode_klasifikasi" class="form-control">
                                                                             <option value="" selected>-- Pilih Kode Klasifikasi --</option>
                                                                            <?php foreach ($klasifikasi as $row) { ?>
                                                                                   <?php 
                                                                                   $selected = ''; 
                                                                                   if($row['kode_klasifikasi']==$arsip['kode_klasifikasi']) $selected = 'selected';
                                                                                   ?>     
                                                                 ...
                                                                 <div class="form-group">
                                                                    ...
                                                                    <div class="col-sm-2">
                                                                        <input disabled type="text" placeholder="Nomor Definitif" id="nomor_definitif" name="nomor_definitif" value="<?php echo $arsip['nomor_definitif']; ?>" class="form-control" number="true" requered="true">
                                                                    </div>
                                                                </div>
                                                                 <div class="form-group">
                                                                    <label class="col-sm-3 control-label" for="kurun_waktu_awal">Kurun Waktu Awal Arsip <span class="symbol required"></span> </label>
                                                                    <div class="col-sm-2">
                                                                        <input disabled type="text" placeholder="Kurun Waktu Awal Arsip" id="kurun_waktu_awal" name="kurun_waktu_awal" value="<?php echo $arsip['kurun_waktu_awal']; ?>" class="form-control" number="true" requered="true">
                                                                    </div>
                                                                </div>
                                                                <div class="form-group">
                                                                    <label class="col-sm-3 control-label" for="kode_jra">Jadwal Retensi Arsip (JRA)</label>
                                                                    <div class="col-sm-9">
                                                                        <select disabled id="kode_jra" name="kode_jra" class="form-control " onchange="getJRA();">
                                                                            <option value="" selected>-- Pilih JRA --</option>
                                                                            <?php foreach ($jra as $row) { ?>

                                                                                <?php 
                                                                                   $selected = ''; 
                                                                                   if($row['kode_jra']==$arsip['kode_jra']) $selected = 'selected';
                                                                                   ?>     
                                                                ...
                                                                <div class="form-group">
                                                                    ...
                                                                    <div class="col-sm-3">
                                                                        <input disabled  type="text" id="jra_aktif" name="jra_aktif" placeholder="Text Field"  class="col-sm-4 form-control" disabled="disabled">
                                                                    </div>
                                                                    <label class="col-sm-3 control-label" for="jra_inaktif">In Aktif</label>
                                                                    <div class="col-sm-3">
                                                                        <input disabled type="text" id="jra_inaktif" name="jra_inaktif" placeholder="Text Field"  class="col-sm-4 form-control" disabled="disabled">
                                                                    </div>
                                                                </div>
                                                                <div class="form-group">
                                                                    <label class="col-sm-3 control-label" for="jra_status">Status</label>
                                                                    <div class="col-sm-3">
                                                                        <input disabled type="text" id="jra_status" name="jra_status" placeholder="Text Field"  class="col-sm-4 form-control" disabled="disabled">
                                                                    </div>
                                                                    <label class="col-sm-3 control-label" for="jra_tahun_musnah">Tahun Musnah</label>
                                                                    <div class="col-sm-3">
                                                                        <input disabled type="text" id="jra_tahun_musnah" name="jra_tahun_musnah" placeholder="Text Field"  class="col-sm-4 form-control" disabled="disabled">
                                                                    </div>
                                                                </div>
                                                                <div class="form-group">
                                                                    <label class="col-sm-3 control-label" for="kode_unit_kerja">Unit Pengelola</label>
                                                                    <div class="col-sm-9">
                                                                        <select disabled class="form-control " id="kode_unit_kerja" name="kode_unit_kerja">
                                                                            <option value="" selected>--Unit Pengelola--</option>
                                                                            <?php foreach ($unit_kerja as $row) { ?>

                                                                                <?php 
                                                                                   $selected = ''; 
                                                                                   if($row['kode_unit_kerja']==$arsip['kode_unit_kerja']) $selected = 'selected';
                                                                                   ?>     
                                                                ...
                                                                <div class="form-group">
                                                                    ...
                                                                    <div class="col-sm-9">
                                                                    <select disabled id="tingkat_perkembangan" name="tingkat_perkembangan" class="form-control ">
                                                                            <option value="" selected>-- Pilih Tingkat Perkembangan --</option>
                                                                            <?php foreach ($tingkat_perkembangan as $row) { ?>

                                                                                <?php 
                                                                                   $selected = ''; 
                                                                                   if($row['tingkat_perkembangan']==$arsip['tingkat_perkembangan']) $selected = 'selected';
                                                                                   ?>     
                                                                ...
                                                                <div class="form-group">
                                                                    ...
                                                                    <div class="col-sm-9">
                                                                    <select disabled id="kondisi_fisik" name="kondisi_fisik" class="form-control ">
                                                                            <option value="" selected>-- Pilih Kondisi Fisik --</option>
                                                                            <?php foreach ($kondisi_fisik as $row) { ?>

                                                                                <?php 
                                                                                   $selected = ''; 
                                                                                   if($row['kondisi_fisik']==$arsip['kondisi_fisik']) $selected = 'selected';
                                                                                   ?>     
                                                                ...
                                                                <div class="form-group">
                                                                    ...
                                                                    <div class="col-sm-9">
                                                                    <select disabled id="media_simpan" name="media_simpan" class="form-control ">  <!--  for search select -->
                                                                            <option value="" selected>-- Pilih Media Simpan --</option>
                                                                            <?php foreach ($media_simpan as $row) { ?>

                                                                                <?php 
                                                                                   $selected = ''; 
                                                                                   if($row['media_simpan']==$arsip['media_simpan']) $selected = 'selected';
                                                                                   ?>     
                                                                ...
                                                                <div class="form-group">
                                                                    ...
                                                                    <div class="col-sm-2">
                                                                        <input disabled type="text" value="<?php echo $arsip['jumlah_berkas'] ?>" placeholder="Jumlah Berkas" id="jumlah_berkas" value="<?php echo $arsip['jumlah_berkas'] ?>" name="jumlah_berkas" class="form-control" number="true" requered="true">
                                                                    </div>
                                                                </div>
                                                                ...
                                                                <div class="form-group">
                                                                    ...
                                                                    <div class="col-sm-9">
                                                                        ...
                                                                        <textarea disabled class="autosize form-control" id="uraian" name="uraian" style="overflow: hidden; word-wrap: break-word; resize: horizontal; height: 69px;"><?php echo $arsip['uraian'] ?></textarea>
                                                                    </div>
                                                                </div>
                            ...
                            <div class="tab-pane" id="tab3">
								...
								<div class="form-group">
                                                                    ...
                                                                    <div class="col-sm-5">
                                                                    <select disabled id="nomor_depo" name="nomor_depo" class="form-control " onchange="changeDepo()">  <!--  for search select -->
                                                                ...
                                                                <div class="form-group">
                                                                    ...
                                                                    <div class="col-sm-5">
                                                                    <select disabled id="nomor_ruang" name="nomor_ruang" class="form-control " onchange="changeRuang()">  <!--  for search select -->
                                                                ...
                                                                <div class="form-group">
                                                                    ...
                                                                    <div class="col-sm-5">
                                                                    <select disabled id="nomor_lemari" name="nomor_lemari" class="form-control " onchange="changeLemari()">  <!--  for search select -->
                                                                ...
                                                                <div class="form-group">
                                                                    ...
                                                                    <div class="col-sm-5">
                                                                    <select disabled id="nomor_boks" name="nomor_boks" class="form-control ">  <!--  for search select -->
                                                                ...
                                                                <div class="form-group">
                                                                    ...
                                                                    <div class="col-sm-2">
                                                                        <input disabled type="text" placeholder="Nomor Folder" id="nomor_folder" name="nomor_folder" class="form-control">
                                                                    </div>
