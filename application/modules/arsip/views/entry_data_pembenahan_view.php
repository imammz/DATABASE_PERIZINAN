...
<body>
                    ...
                    <div class="col-sm-12">							
                         <!-- start: PAGE TITLE & BREADCRUMB -->
                            ...
                            <div class="page-header">
                                <h1>Entry Data Pembenahan</h1>
                            </div>
                            <!-- end: PAGE TITLE & BREADCRUMB -->
                        <p align="right">
                            <a href="#modalImportExcel" data-toggle="modal" class="btn btn-blue"><i class="clip-file-excel "></i> Import From Excel </a> &nbsp;
                            <a href="#modalExportExcel" data-toggle="modal" class="btn btn-success"><i class="clip-file-excel "></i> Export Data To Excel </a> &nbsp;
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                <table class="table table-striped table-bordered table-hover table-full-width" id="sample_1">
                                    <thead>
                                        <tr>
                                            ...
                                            <th class="hidden-xs" width="55">Sudah Di-Export</th>
                               ...
                               <?php $this->load->view('entry_data_pembenahan_form_view'); ?>
                                
                                <div id="modalExportExcel" class="modal fade" tabindex="-1" data-width="960" style="display: none;">
                                    <div class="modal-header">
                                        <button type="button" class="close" data-dismiss="modal" aria-hidden="true">
                                            &times;
                                        </button>
                                        <h4 class="modal-title">Export Data To Excel</h4>
                                    </div>
                               
                                    <div class="modal-body center">
                                       
                                       <a href="<?php echo base_url() ?>pemindahan/entrypembenahan/exportExcelAll" class="btn btn-primary"><i class="clip-file-excel "></i> Semua Data Pembenahan </a>
                                       &nbsp; &nbsp; &nbsp;
                                       <a href="<?php echo base_url() ?>pemindahan/entrypembenahan/exportExcel" class="btn btn-blue"><i class="clip-file-excel "></i> Hanya Data Yang Belum Pernah Di Export </a>
                                        <br/> <br/>
                                       <div class="center alert alert-danger">
                                           Jika file hasil Export ingin <strong>DiImport ke menu Entry Data</strong>, harap file hasil Export di <strong>Save As</strong> dahulu.
                                       </div>
                                ...
                                <div id="modalImportExcel" class="modal fade" tabindex="-1" data-width="760" style="display: none;">
                                    <form method="POST" action="<?php echo base_url() ?>pemindahan/entrypembenahan/importExcel" enctype="multipart/form-data">                                   
                                    <div class="modal-header">
                                        <button type="button" class="close" data-dismiss="modal" aria-hidden="true">
                                            &times;
                                        </button>
    ...
    <script>
     ...
     function formDetilPenerimaan(id) {
            GB_show("Detil Data Arsip", '<?php echo base_url(); ?>pemindahan/entrypembenahan/detil/'+id, 900, 1070);
           $('html, body').animate({ scrollTop: 0 }, 'slow');
        }
     function formUpload(id) {
            GB_show("Upload File Arsip", '<?php echo base_url(); ?>pemindahan/entrypembenahan/upload/'+id, 300, 500);
            $('html, body').animate({ scrollTop: 0 }, 'slow');
        }
  ...
  function getJRA() {
    ...
    function changeLemari() {
        ...
        function processSubmitForm() {
            ...
            var url = '<?php echo base_url() ?>pemindahan/entrypembenahan/process/insert';
        ...
        var TableData1 = function() {
            ...
            var runDataTable = function() {
                var oTable = $('#sample_1').dataTable({
                    "bProcessing": true,
                    "bServerSide": true,
                    "sAjaxSource": "<?php echo base_url() ?>pemindahan/entrypembenahan/load/",
                    "aoColumnDefs": [{
                            "aTargets": [0]
                        }],
                    "oLanguage": {
