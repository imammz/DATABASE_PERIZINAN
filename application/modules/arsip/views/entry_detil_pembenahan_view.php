    ...
    <!-- start: MAIN CONTAINER -->
        ...
        <div style="background-color: #ffffff">
          ...
          <div class="modal-footer">
              <a onclick="return confirm('Anda yakin akan menghapus data arsip ini?')" href="<?php echo base_url() ?>pemindahan/entrypembenahan/process/delete/<?php echo $id_arsip ?>"> 
...
<i class="fa fa-trash-o"></i>
    ...
    function changeLemari() {
        ...
        function processSubmitForm() {
            ...
            var url = '<?php echo base_url() ?>pemindahan/entrypembenahan/process/update/<?php echo $id_arsip ?>';
