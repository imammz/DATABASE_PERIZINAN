        ...
        <div class="wrap-content container" id="container">
            ...
            <div class="container-fluid container-fullw bg-white">
                <ol class="breadcrumb">
                    ...
                    <li><a href="#">Perekaman Arsip</a></li>
                </ol>
                <div id="tabs">
                    <ul class="nav-tabs btn-group">
                        <li class="btn btn-default"><a href="#tabs-1">Perekaman Arsip</a></li>
                    </ul>
                    <div id="tabs-1" class="tabs-content">
                        
                          <iframe width="100%" style="min-height: 1250px" 
                                        src="http://<?php echo HOST; ?>/ARCHIS-KOTABEKASI/index.php/pemindahan/pencarian">
                          </iframe> 
