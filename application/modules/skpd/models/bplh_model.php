...
class Bplh_model extends CI_Model {
    ...
    public function _loadIzinLingkunganProses($id_permohonan = null) {
        $this->db->select('*');
        ...
        $this->db->join('tbl_t_badan_usaha_ili c', 'a.id_permohonan = c.id_permohonan','LEFT');
