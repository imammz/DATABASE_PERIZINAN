...
<html lang="en">
	...
	<head>
		...
		<!-- end: META -->
        <!-- start: WEBSITE SHORTCUT ICON -->
        <link rel="shortcut icon" href="<?php echo PATH_ASSETS; ?>assets/images/shortcut-icon.png">
        <!-- end: WEBSITE SHORTCUT ICON -->
		<!-- start: GOOGLE FONTS -->
		<link href="http://fonts.googleapis.com/css?family=Lato:300,400,400italic,600,700|Raleway:300,400,500,600,700|Crete+Round:400italic" rel="stylesheet" type="text/css" />
		<!-- end: GOOGLE FONTS -->
		<!-- start: MAIN CSS -->
        <link rel="stylesheet" href="<?php echo PATH_ASSETS; ?>assets/css/jquery-ui.min.css">
		<link rel="stylesheet" href="<?php echo PATH_ASSETS; ?>vendor/bootstrap/css/bootstrap.min.css">
        <link rel="stylesheet" href="<?php echo PATH_ASSETS; ?>vendor/bootstrap-datepicker/bootstrap-datepicker3.standalone.min.css">
        ...
        <link href="<?php echo PATH_ASSETS; ?>assets/css/jquery.treetable.css">
        <link href="<?php echo PATH_ASSETS; ?>assets/css/nyroModal.css">
		<!-- end: MAIN CSS -->
		<!-- start: CLIP-TWO CSS -->
        ...
        <script src="<?php echo PATH_ASSETS ?>vendor/jquery/jquery-ui.min.js"></script>
		<!-- end: CLIP-TWO CSS -->
		<!-- start: CSS REQUIRED FOR THIS PAGE ONLY -->
                	<link href="<?php echo PATH_ASSETS ?>vendor/select2/select2.min.css" rel="stylesheet" media="screen">
		<link href="<?php echo PATH_ASSETS ?>vendor/DataTables/css/DT_bootstrap.css" rel="stylesheet" media="screen">
