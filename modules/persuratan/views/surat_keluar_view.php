                ...
                <div id="tabs">
                    ...
                    <div id="tabs-1" class="tabs-content">
                        <div class="text-right"> 
                            <a class="show-modal btn btn-info" href="<?php echo site_url('persuratan/surat_keluar/form'); ?>"><i class="fa fa-plus-circle"></i> Create Surat Keluar</a>
                        </div>
                            ...
                            <tbody>
                              ...
                              foreach($surat as $row) { ?>  
                                <tr>
                                    ...
                                    <td><a class="show-modal btn btn-info" href="<?php echo site_url('persuratan/surat_keluar/baca/'.$row['id_surat']) ?>"><i class="fa fa-book"></i></a></td>
                                </tr>
                              <?php $no++; } ?>
