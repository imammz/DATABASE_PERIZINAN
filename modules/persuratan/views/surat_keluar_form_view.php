            ...
            <div id="tabs-1" class="tabs-content fade in active"> 
                ...
                <fieldset>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <input  type="text" placeholder="Nomor Surat" name="nomor"  class="form-control">
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="col-sm-2 control-label">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <textarea  name="isi" cols="80" rows="5">   </textarea>
                        </div>
                    </div>
            ...
            <div id="tabs-4" class="tabs-content"> 
                <div class="form-group">
                    <div class="col-sm-5">                        
                        ...
                        <button class="btn btn-dark-yellow" type="reset">
                            Batal
                        </button>                        
                    </div>                    
...
<!--                            <a class="btn btn-danger" onclick="return confirm('anda yakin TIDAK MENERBITKAN Rekomendasi untuk <?php echo $permohonan['pemohon']['nama'].' ('.$permohonan['no_permohonan'].')' ?>');" href="<?php echo site_url('skpd/tatakota/tidaklayak/'.$permohonan['id_permohonan']) ?>" >
                            ...
                            <input class="btn btn-dark-blue" type="submit" value="Simpan Data Perubahan"/>
                        </div>
                    </div>
                </div>
