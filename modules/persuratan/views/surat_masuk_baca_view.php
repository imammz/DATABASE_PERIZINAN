        ...
        <div id="tabs">
            ...
            <div id="tabs-4" class="tabs-content"> 
                ...
                <div class="form-group">
                    <div class="col-sm-5">                        
                        <a class="show-modal btn btn-danger" onclick="return confirm('Apakah Anda Yakin Akan Menghapus Surat ini  (<?php echo $surat['perihal'];?>) ?')" href="<?php echo site_url('persuratan/surat_masuk/hapus/'.$surat['id_surat']) ?>"><i class="fa fa-trash"></i> Hapus</a> 
                                             
                    </div>                    
                    <div class="col-sm-7">
                        <div class="pull-right">

                            <a class="show-modal btn btn-warning" href="<?php echo site_url('persuratan/surat_masuk/edit/'.$surat['id_surat']) ?>"><i class="fa fa-pencil-square"></i> Edit </a>
                            &nbsp;
