    ...
    <div class="main-content" >
        <div class="wrap-content container" id="container">
            ...
            <section id="page-title">
                <div class="row">
                    <div class="col-sm-8">
                        <h1 class="mainTitle">Dinas Kesehatan</h1>
                    </div>
                </div>
            </section>
            <div class="container-fluid container-fullw bg-white">
                <ol class="breadcrumb">
                    ...
                    <li><a href="<?php echo PATH_ASSETS; ?>skpd">Dinas Kesehatan</a></li>
                </ol>

                <div id="tabs">
                    <ul class="nav-tabs btn-group">
                        <li class="btn btn-default"><a href="#tabs-1">Izin Praktek Bidan</a></li>
                        <li class="btn btn-default"><a href="#tabs-2">Izin Praktek Dokter</a></li>
                        <li class="btn btn-default"><a href="#tabs-3">Izin Apotek</a></li>
                    </ul>
