    ...
    <div class="main-content" >
        <div class="wrap-content container" id="container">
            ...
            <section id="page-title">
                <div class="row">
                    <div class="col-sm-8">
                        <h1 class="mainTitle">Dinas Tata Kota</h1>
                    </div>
                </div>
            </section>
            <div class="container-fluid container-fullw bg-white">
                <ol class="breadcrumb">
                    ...
                    <li><a href="<?php echo PATH_ASSETS; ?>skpd">Dinas Tata Kota</a></li>
                </ol>

                <div id="tabs">
                    <ul class="nav-tabs btn-group">
                        <li class="btn btn-default"><a href="#tabs-1">IMB </a></li>
                        <li class="btn btn-default"><a href="#tabs-2">Site Plan</a></li>
                        <li class="btn btn-default"><a href="#tabs-3">IPPL</a></li>
                    </ul>
...
<!--                                <div class="tab-pane" id="cetak" style="min-height: 400px;">
                    ...
                    <div id="tabs-2">  
                        ...
                        <div class="tabbable tabs-right">
                            <ul id="myTab5" class="nav nav-tabs">
                                <li class="active">
                                    <a href="#belum-a" data-toggle="tab">
                                        Belum Di Proses
                                    </a>
                                </li>
                                <li class="">
                                    <a href="#terbit-a" data-toggle="tab">
                                        Terbit Rekom
                                    </a>
                                </li>
                                <li class="">
                                    <a href="#tidak_terbit-a" data-toggle="tab">
                                        Tidak Terbit Rekom
                                    </a>
                                </li>
<!--                                <li class="">
                            ...
                            <div class="tab-content">
                                <div class="tab-pane fade in active" id="belum-a" style="min-height: 400px;">
                                    <table class="table table-striped table-bordered table-hover table-full-width" id="sample_2">
                                        <thead>
                                            <tr>
                                                ...
                                                <th class="hidden-xs">Nomor Permohonan</th>
                                                <th class="hidden-xs">Pemohon</th>
                                                <th class="hidden-xs">Status Tanah</th>
                                                <th class="hidden-xs">peruntukan Tanah</th>
                                                <th class="hidden-xs">Proses</th>
                                            </tr>
                                        </thead>
                                        <tbody>
...
<!--                                        <tbody>
                                ...
                                <div class="tab-pane" id="terbit-a" style="min-height: 400px;">
                                    <table class="table table-striped table-bordered table-hover table-full-width" id="sample_2a">
                                        <thead>
                                            <tr>
                                                <th class="center">No.</th>
                                                <th width="20%">Tanggal</th>
...
<!--                                        <tbody>
                                 ...
                                 <div class="tab-pane" id="tidak_terbit-a" style="min-height: 400px;">
                                    
                                     <table class="table table-striped table-bordered table-hover table-full-width" id="sample_2b">
                                        <thead>
                                            <tr>
                                                <th class="center">No.</th>
                                                <th width="20%">Tanggal</th>
...
<!--                                <div class="tab-pane" id="cetak" style="min-height: 400px;">
                    ...
                    <div id="tabs-3" >  
                        ...
                        <div class="tabbable tabs-right">
                            <ul id="myTab5" class="nav nav-tabs">
                                <li class="active">
                                    <a href="#belum-b" data-toggle="tab">
                                        Belum Di Proses
                                    </a>
                                </li>
                                <li class="">
                                    <a href="#terbit-b" data-toggle="tab">
                                        Terbit Rekom
                                    </a>
                                </li>
                                <li class="">
                                    <a href="#tidak_terbit-b" data-toggle="tab">
                                        Tidak Terbit Rekom
                                    </a>
                                </li>
<!--                                <li class="">
                            ...
                            <div class="tab-content">
                                <div class="tab-pane fade in active" id="belum-b" style="min-height: 400px;">
                                    <table class="table table-striped table-bordered table-hover table-full-width" id="sample_2">
                                        <thead>
                                            <tr>
                                                <th class="center">No.</th>
...
<!--                                        <tbody>
                                ...
                                <div class="tab-pane" id="terbit-b" style="min-height: 400px;">
                                    <table class="table table-striped table-bordered table-hover table-full-width" id="sample_2a">
                                        <thead>
                                            <tr>
                                                <th class="center">No.</th>
...
<!--                                        <tbody>
                                 ...
                                 <div class="tab-pane" id="tidak_terbit-b" style="min-height: 400px;">
